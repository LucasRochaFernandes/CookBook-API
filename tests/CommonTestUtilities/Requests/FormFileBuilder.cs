...
public class FormFileBuilder
{
    public static IFormFile Png()
    {
        ...
        var file = new FormFile(baseStream: stream, baseStreamOffset: 0, length: stream.Length,
            name: "File", fileName: "IMG0001.png")
        {
    ...
    public static IFormFile Jpg()
    {
        ...
        var file = new FormFile(baseStream: stream, baseStreamOffset: 0, length: stream.Length,
            name: "File", fileName: "IMG0001.jpg")
        {
            Headers = new HeaderDictionary(),
    ...
    public static IFormFile Txt()
    {
        ...
        var file = new FormFile(baseStream: stream, baseStreamOffset: 0, length: stream.Length,
            name: "File", fileName: "FILE0001.txt")
        {
            Headers = new HeaderDictionary(),
